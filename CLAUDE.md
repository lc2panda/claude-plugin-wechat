...
### 第十二次校验（协议审查 /review 2026-07-23）

| 项目 | 值 |
|------|-----|
| 校验发起 | 2026-07-23 10:59:38 +08:00 |
| 校验完成 | 2026-07-23 10:59:43 +08:00 |
| 本机系统时间 | 2026-07-22 19:59:38 -0700 (PDT) / 等效 2026-07-23 10:59:38 +08:00 (Asia/Shanghai 与 Asia/Singapore，+08:00) / UTC 2026-07-23 02:59:38 |
| 时间源 1 | Google HTTPS Date → `Thu, 23 Jul 2026 02:59:39 GMT` = 10:59:39 +08:00 |
| 时间源 2 | Cloudflare HTTPS Date → `Thu, 23 Jul 2026 02:59:40 GMT` = 10:59:40 +08:00 |
| 时间源 3 | GitHub HTTPS Date → `Thu, 23 Jul 2026 02:59:41 GMT` = 10:59:41 +08:00 |
| 时间源 4 | Baidu HTTPS Date → `Thu, 23 Jul 2026 02:59:42 GMT` = 10:59:42 +08:00 |
| 时间源 5 | Microsoft HTTPS Date → `Thu, 23 Jul 2026 02:59:43 GMT` = 10:59:43 +08:00 |
| 时间源 6 | Apple HTTPS Date → 无 Date 响应头（源不可用，已排除） |
| 最大偏差 | 5 秒（本机 02:59:38 UTC vs Microsoft 02:59:43 GMT；网络源互偏差 4 秒 Google vs Microsoft；阈值 100 秒） |
| **判定** | **通过 ✓** |
| 备注 | 有效网络源 5/6（≥2）；网络源互偏差 ≤4 秒；本机与网络高度一致。本时间戳用作协议审查 /review 2026-07-23 基准锚点。 |
...
## 19. 协议审查综合（2026-07-23）

> **审查时间锚点**：2026-07-23 10:59:43 +08:00  
> **综合报告生成**：2026-07-23 11:44:34 +08:00  
> **HEAD**：`ac5577602c8271d7264cd841ea104a5ad13f973b`  
> **角色**：A-框架 / B-微信 / C-飞书 / D-ACP·MCP / E-综合  
> **约束**：本轮只读调研 + 文档落盘；**未改** `channels/**` 业务代码；**未** commit/push（统一由 F 处理）

### 19.1 摘要指针（全文勿粘贴，以 docs 为准）

| 文档 | 路径 |
|------|------|
| 综合对齐 + 执行方案 | `docs/20260723-05-alignment-and-plan.md` |
| 框架审查 | `docs/20260723-01-framework-review.md` |
| 微信 iLink | `docs/20260723-02-wechat-ilink-protocol.md` |
| 飞书/Lark | `docs/20260723-03-feishu-lark-protocol.md` |
| ACP/MCP 第一性原理 | `docs/20260723-04-acp-mcp-first-principles.md` |
| docs 领地标记 | `docs/README.md` |

### 19.2 版本快照（相对 §15 基线）

| 组件 | §15 基线 (2026-06-23) | 官方 latest (2026-07-23) | 本仓 lock/运行 |
|------|----------------------|--------------------------|----------------|
| openclaw-weixin（iLink 参照） | 2.4.6 | **2.4.6**（无新版） | 直连 HTTP，核心对齐 |
| `@larksuiteoapi/node-sdk` | 1.67.0 | **1.71.1** | **1.67.0**（落后） |
| `@modelcontextprotocol/sdk` | 1.29.0 可升 | **1.29.0** | **1.27.1** |
| `@agentclientprotocol/sdk` | 文档写 0.29 | **1.3.0** | **0.16.1 only**（`^0.16.1`） |
| claude-agent-acp | 注释 0.49.0 | **0.61.0** | npx **无 pin** → latest |
| codex-acp | 0.16.0 | 0.16.0 | **@0.16.0 对齐** |

### 19.3 P0 合并（3 项，详表见 05）

1. **ACP 双进程 SDK 世代分裂**（Client 0.16.1 vs agent 1.3.0）  
2. **ACP requestPermission 默认 auto-allow**（架空 Channel 远程审批）  
3. **飞书 SDK≥1.71.1**（axios 安全 floor ≥1.16.0）  

微信 iLink **P0 协议断裂 = 0**；`bot_agent` 应迁入 `base_info` 为 **P1**。

### 19.4 最优方案第一步

钉死/对齐 ACP Client 与 `claude-agent-acp` 版本矩阵（禁止 silent latest），启动日志输出双方版本。详见 05 §5 步骤 1.1。
